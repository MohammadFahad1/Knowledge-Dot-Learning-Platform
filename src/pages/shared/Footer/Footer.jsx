        ...
        <footer aria-label="Site Footer" className="bg-gray-100">
            <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="flex justify-center">
                    <Link className="btn btn-ghost normal-case text-xl flex" to='/'><img src={logo} style={{ height: '40px' }} className='rounded-full bg-warning mr-1'></img> Knowledge .</Link>
                </div>
                ...
                <nav aria-label="Footer Nav" className="mt-12">
                    <ul className="flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
                        ...
                        <li>
                            <Link className="text-gray-700 transition hover:text-gray-700/75" to="/courses">
                                Courses
                            </Link>
                        </li>
